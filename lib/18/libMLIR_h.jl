...
function beaverEnterMultiThreadedExecution(context)
    @ccall mlir_c.beaverEnterMultiThreadedExecution(context::MlirContext)::Cvoid
end

function beaverExitMultiThreadedExecution(context)
    @ccall mlir_c.beaverExitMultiThreadedExecution(context::MlirContext)::Cvoid
end
...
struct MlirRegisteredOperationName
    ptr::Ptr{Cvoid}
end
...
function beaverIsOpNameTerminator(op_name, context)
    @ccall mlir_c.beaverIsOpNameTerminator(op_name::MlirStringRef, context::MlirContext)::Bool
end

function beaverGetNumRegisteredOperations(context)
    @ccall mlir_c.beaverGetNumRegisteredOperations(context::MlirContext)::intptr_t
end

function beaverGetRegisteredOperationName(context, pos)
    @ccall mlir_c.beaverGetRegisteredOperationName(context::MlirContext, pos::intptr_t)::MlirRegisteredOperationName
end

function beaverRegisteredOperationNameGetDialectName(name)
    @ccall mlir_c.beaverRegisteredOperationNameGetDialectName(name::MlirRegisteredOperationName)::MlirStringRef
end

function beaverRegisteredOperationNameGetOpName(name)
    @ccall mlir_c.beaverRegisteredOperationNameGetOpName(name::MlirRegisteredOperationName)::MlirStringRef
end

function beaverRegisteredOperationsOfDialect(context, dialect, ret, num)
    @ccall mlir_c.beaverRegisteredOperationsOfDialect(context::MlirContext, dialect::MlirStringRef, ret::Ptr{MlirRegisteredOperationName}, num::Ptr{Csize_t})::Cvoid
end

function beaverRegisteredDialects(context, ret, num)
    @ccall mlir_c.beaverRegisteredDialects(context::MlirContext, ret::Ptr{MlirStringRef}, num::Ptr{Csize_t})::Cvoid
end

function beaverValueGetFirstOperand(value)
    @ccall mlir_c.beaverValueGetFirstOperand(value::MlirValue)::MlirOperand
end

function beaverOperandGetNext(operand)
    @ccall mlir_c.beaverOperandGetNext(operand::MlirOperand)::MlirOperand
end

function beaverOperandIsNull(operand)
    @ccall mlir_c.beaverOperandIsNull(operand::MlirOperand)::Bool
end

function beaverOperandGetValue(operand)
    @ccall mlir_c.beaverOperandGetValue(operand::MlirOperand)::MlirValue
end

function beaverOperandGetOwner(operand)
    @ccall mlir_c.beaverOperandGetOwner(operand::MlirOperand)::MlirOperation
end

function beaverOperandGetNumber(operand)
    @ccall mlir_c.beaverOperandGetNumber(operand::MlirOperand)::intptr_t
end

function beaverStringRefGetData(string_ref)
    @ccall mlir_c.beaverStringRefGetData(string_ref::MlirStringRef)::Cstring
end

function beaverStringRefGetLength(string_ref)
    @ccall mlir_c.beaverStringRefGetLength(string_ref::MlirStringRef)::Csize_t
end

function beaverContextIsNull(context)
    @ccall mlir_c.beaverContextIsNull(context::MlirContext)::Bool
end

function beaverDialectIsNull(dialect)
    @ccall mlir_c.beaverDialectIsNull(dialect::MlirDialect)::Bool
end

function beaverDialectRegistryIsNull(registry)
    @ccall mlir_c.beaverDialectRegistryIsNull(registry::MlirDialectRegistry)::Bool
end

function beaverLocationIsNull(location)
    @ccall mlir_c.beaverLocationIsNull(location::MlirLocation)::Bool
end

function beaverModuleIsNull(_module)
    @ccall mlir_c.beaverModuleIsNull(_module::MlirModule)::Bool
end

function beaverOperationIsNull(op)
    @ccall mlir_c.beaverOperationIsNull(op::MlirOperation)::Bool
end

function beaverRegionIsNull(region)
    @ccall mlir_c.beaverRegionIsNull(region::MlirRegion)::Bool
end

function beaverBlockIsNull(block)
    @ccall mlir_c.beaverBlockIsNull(block::MlirBlock)::Bool
end

function beaverValueIsNull(value)
    @ccall mlir_c.beaverValueIsNull(value::MlirValue)::Bool
end

function beaverTypeIsNull(type)
    @ccall mlir_c.beaverTypeIsNull(type::MlirType)::Bool
end

function beaverAttributeIsNull(attr)
    @ccall mlir_c.beaverAttributeIsNull(attr::MlirAttribute)::Bool
end

function beaverSymbolTableIsNull(symbolTable)
    @ccall mlir_c.beaverSymbolTableIsNull(symbolTable::MlirSymbolTable)::Bool
end

function beaverMlirOperationStateGetName(state)
    @ccall mlir_c.beaverMlirOperationStateGetName(state::MlirOperationState)::MlirStringRef
end

function beaverMlirOperationStateGetContext(state)
    @ccall mlir_c.beaverMlirOperationStateGetContext(state::MlirOperationState)::MlirContext
end

function beaverMlirOperationStateGetLocation(state)
    @ccall mlir_c.beaverMlirOperationStateGetLocation(state::MlirOperationState)::MlirLocation
end

function beaverMlirOperationStateGetNumResults(state)
    @ccall mlir_c.beaverMlirOperationStateGetNumResults(state::MlirOperationState)::intptr_t
end

function beaverMlirOperationStateGetNumOperands(state)
    @ccall mlir_c.beaverMlirOperationStateGetNumOperands(state::MlirOperationState)::intptr_t
end

function beaverMlirOperationStateGetNumRegions(state)
    @ccall mlir_c.beaverMlirOperationStateGetNumRegions(state::MlirOperationState)::intptr_t
end

function beaverMlirOperationStateGetNumAttributes(state)
    @ccall mlir_c.beaverMlirOperationStateGetNumAttributes(state::MlirOperationState)::intptr_t
end

function beaverLogicalResultIsSuccess(res)
    @ccall mlir_c.beaverLogicalResultIsSuccess(res::MlirLogicalResult)::Bool
end

function beaverLogicalResultIsFailure(res)
    @ccall mlir_c.beaverLogicalResultIsFailure(res::MlirLogicalResult)::Bool
end

function beaverLogicalResultSuccess()
    @ccall mlir_c.beaverLogicalResultSuccess()::MlirLogicalResult
end

function beaverLogicalResultFailure()
    @ccall mlir_c.beaverLogicalResultFailure()::MlirLogicalResult
end

function beaverOperationGetName(op, pos)
    @ccall mlir_c.beaverOperationGetName(op::MlirOperation, pos::intptr_t)::MlirIdentifier
end

function beaverOperationGetAttribute(op, pos)
    @ccall mlir_c.beaverOperationGetAttribute(op::MlirOperation, pos::intptr_t)::MlirAttribute
end

function beaverMlirNamedAttributeGetName(arg1)
    @ccall mlir_c.beaverMlirNamedAttributeGetName(arg1::MlirNamedAttribute)::MlirIdentifier
end

function beaverMlirNamedAttributeGetAttribute(na)
    @ccall mlir_c.beaverMlirNamedAttributeGetAttribute(na::MlirNamedAttribute)::MlirAttribute
end

function beaverCreateExternalPass(construct, passID, name, argument, description, opName, nDependentDialects, dependentDialects, destruct, initialize, clone, run, userData)
    @ccall mlir_c.beaverCreateExternalPass(construct::Ptr{Cvoid}, passID::MlirTypeID, name::MlirStringRef, argument::MlirStringRef, description::MlirStringRef, opName::MlirStringRef, nDependentDialects::intptr_t, dependentDialects::Ptr{MlirDialectHandle}, destruct::Ptr{Cvoid}, initialize::Ptr{Cvoid}, clone::Ptr{Cvoid}, run::Ptr{Cvoid}, userData::Ptr{Cvoid})::MlirPass
end

function beaverGetReassociationIndicesForReshape(sourceType, targetType)
    @ccall mlir_c.beaverGetReassociationIndicesForReshape(sourceType::MlirType, targetType::MlirType)::MlirAttribute
end

function beaverLocationPrint(location, callback, userData)
    @ccall mlir_c.beaverLocationPrint(location::MlirLocation, callback::MlirStringCallback, userData::Ptr{Cvoid})::Cvoid
end

function beaverOperationDumpGeneric(op)
    @ccall mlir_c.beaverOperationDumpGeneric(op::MlirOperation)::Cvoid
end
...
function beaverMlirExecutionEngineIsNull(w)
    @ccall mlir_c.beaverMlirExecutionEngineIsNull(w::MlirExecutionEngine)::Bool
end
...
function beaverPDLPatternGet(_module)
    @ccall mlir_c.beaverPDLPatternGet(_module::MlirModule)::MlirPDLPatternModule
end

function beaverRewritePatternSetGet(context)
    @ccall mlir_c.beaverRewritePatternSetGet(context::MlirContext)::MlirRewritePatternSet
end

function beaverPatternSetAddOwnedPDLPattern(patternList, pdlPattern)
    @ccall mlir_c.beaverPatternSetAddOwnedPDLPattern(patternList::MlirRewritePatternSet, pdlPattern::MlirPDLPatternModule)::MlirRewritePatternSet
end

function beaverApplyOwnedPatternSetOnRegion(region, patternList)
    @ccall mlir_c.beaverApplyOwnedPatternSetOnRegion(region::MlirRegion, patternList::MlirRewritePatternSet)::MlirLogicalResult
end

function beaverApplyOwnedPatternSetOnOperation(op, patternList)
    @ccall mlir_c.beaverApplyOwnedPatternSetOnOperation(op::MlirOperation, patternList::MlirRewritePatternSet)::MlirLogicalResult
end
...
@cenum MlirSparseTensorDimLevelType::UInt32 begin
    ...
    MLIR_SPARSE_TENSOR_DIM_LEVEL_LOOSE_COMPRESSED = 0x0000000000000020
    MLIR_SPARSE_TENSOR_DIM_LEVEL_LOOSE_COMPRESSED_NU = 0x0000000000000021
    MLIR_SPARSE_TENSOR_DIM_LEVEL_LOOSE_COMPRESSED_NO = 0x0000000000000022
    MLIR_SPARSE_TENSOR_DIM_LEVEL_LOOSE_COMPRESSED_NU_NO = 0x0000000000000023
...
function mlirSparseTensorEncodingAttrGet(ctx, lvlRank, lvlTypes, dimToLvl, lvlTodim, posWidth, crdWidth)
    @ccall mlir_c.mlirSparseTensorEncodingAttrGet(ctx::MlirContext, lvlRank::intptr_t, lvlTypes::Ptr{MlirSparseTensorDimLevelType}, dimToLvl::MlirAffineMap, lvlTodim::MlirAffineMap, posWidth::Cint, crdWidth::Cint)::MlirAttribute
end
...
function mlirSparseTensorEncodingAttrGetLvlType(attr, lvl)
    @ccall mlir_c.mlirSparseTensorEncodingAttrGetLvlType(attr::MlirAttribute, lvl::intptr_t)::MlirSparseTensorDimLevelType
end
