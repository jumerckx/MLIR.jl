...
"""
function Condition(; location::Location, condition_::Value, args_::Vector{Value})
  results = []
  operands = [condition_, args_...]
  regions = []
  successors = []
  attributes = []
...
"""
function ExecuteRegion(; location::Location, _unnamed0_::Vector{MLIRType}, region_::Region)
  results = [_unnamed0_...]
  operands = []
  regions = [region_]
  successors = []
...
"""
function For(; location::Location, results_::Vector{MLIRType}, lowerBound_::Value, upperBound_::Value, step_::Value, initArgs_::Vector{Value}, region_::Region)
  results = [results_...]
  operands = [lowerBound_, upperBound_, step_, initArgs_...]
  regions = [region_]
  successors = []
  attributes = []
...
"""
function Forall(; location::Location, results_::Vector{MLIRType}, dynamicLowerBound_::Vector{Value}, dynamicUpperBound_::Vector{Value}, dynamicStep_::Vector{Value}, outputs_::Vector{Value}, region_::Region, staticLowerBound_::Union{NamedAttribute, Attribute}, staticUpperBound_::Union{NamedAttribute, Attribute}, staticStep_::Union{NamedAttribute, Attribute}, mapping_=nothing::Union{Nothing, Union{NamedAttribute, Attribute}})
  results = [results_...]
  operands = [dynamicLowerBound_..., dynamicUpperBound_..., dynamicStep_..., outputs_...]
  regions = [region_]
  successors = []
  attributes = [make_named_attribute("staticLowerBound", staticLowerBound_), make_named_attribute("staticUpperBound", staticUpperBound_), make_named_attribute("staticStep", staticStep_)]

  (mapping_ != nothing) && push!(attributes, make_named_attribute("mapping", mapping_))
...
"""
function If(; location::Location, results_::Vector{MLIRType}, condition_::Value, thenRegion_::Region, elseRegion_::Region)
  results = [results_...]
  operands = [condition_]
...
"""
function InParallel(; location::Location, region_::Region)
  results = []
  operands = []
  regions = [region_]
  successors = []
  ...
  create_operation(
        "scf.forall.in_parallel", location, 
        results = results, 
        operands = operands,
        owned_regions = regions, 
        successors = successors, 
...
"""
function IndexSwitch(; location::Location, results_::Vector{MLIRType}, arg_::Value, defaultRegion_::Region, caseRegions_::Vector{Region}, cases_::Union{NamedAttribute, Attribute})
  results = [results_...]
  operands = [arg_]
  regions = [defaultRegion_, caseRegions_...]
  successors = []
  attributes = [make_named_attribute("cases", cases_)]
...
"""
function Parallel(; location::Location, results_::Vector{MLIRType}, lowerBound_::Vector{Value}, upperBound_::Vector{Value}, step_::Vector{Value}, initVals_::Vector{Value}, region_::Region)
  results = [results_...]
  operands = [lowerBound_..., upperBound_..., step_..., initVals_...]
  regions = [region_]
  successors = []
  attributes = []
...
"""
function Reduce(; location::Location, operand_::Value, reductionOperator_::Region)
  results = []
  operands = [operand_]
  regions = [reductionOperator_]
  successors = []
  attributes = []
...
"""
function ReduceReturn(; location::Location, result_::Value)
  results = []
  operands = [result_]
  regions = []
  successors = []
...
"""
function While(; location::Location, results_::Vector{MLIRType}, inits_::Vector{Value}, before_::Region, after_::Region)
  results = [results_...]
  operands = [inits_...]
  regions = [before_, after_]
  successors = []
  attributes = []
...
"""
function Yield(; location::Location, results_::Vector{Value})
  results = []
  operands = [results_...]
  regions = []
  successors = []
