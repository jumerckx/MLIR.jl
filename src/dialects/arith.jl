...
"""
function addf(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
...
```
"""
function addi(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function addui_extended(lhs, rhs; sum::MLIRType, overflow::MLIRType, location=Location())
...
```
"""
function andi(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function bitcast(in; out::MLIRType, location=Location())
...
```
"""
function ceildivsi(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function ceildivui(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function cmpf(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, predicate, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function cmpi(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, predicate, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function divf(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function divsi(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function divui(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function extf(in; out::MLIRType, location=Location())
    results = MLIRType[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function extsi(in; out::MLIRType, location=Location())
    results = MLIRType[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function extui(in; out::MLIRType, location=Location())
    results = MLIRType[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
elementwise.
"""
function fptosi(in; out::MLIRType, location=Location())
    results = MLIRType[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
elementwise.
"""
function fptoui(in; out::MLIRType, location=Location())
    results = MLIRType[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function floordivsi(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function index_cast(in; out::MLIRType, location=Location())
    results = MLIRType[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
integer, the value is truncated.
"""
function index_castui(in; out::MLIRType, location=Location())
    results = MLIRType[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function maxnumf(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function maxsi(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function maxui(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function maximumf(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function minnumf(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function minsi(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function minui(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function minimumf(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
math, contraction, rounding mode, and other controls.
"""
function mulf(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
standard attributes.
"""
function muli(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function mulsi_extended(lhs, rhs; low=nothing::Union{Nothing, MLIRType}, high=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function mului_extended(lhs, rhs; low=nothing::Union{Nothing, MLIRType}, high=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function negf(operand; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
...
```
"""
function ori(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function remf(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function remsi(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function remui(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
elementwise.
"""
function sitofp(in; out::MLIRType, location=Location())
    results = MLIRType[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function shli(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function shrsi(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function shrui(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
math, contraction, rounding mode, and other controls.
"""
function subf(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
standard attributes.
"""
function subi(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function truncf(in; out::MLIRType, location=Location())
    results = MLIRType[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function trunci(in; out::MLIRType, location=Location())
    results = MLIRType[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
elementwise.
"""
function uitofp(in; out::MLIRType, location=Location())
    results = MLIRType[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function xori(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
