...
```
"""
function call_indirect(callee, callee_operands; results::Vector{MLIRType}, location=Location())
...
```
"""
function call(operands; result_0::Vector{MLIRType}, callee, location=Location())
