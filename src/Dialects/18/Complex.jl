...
```
"""
function abs(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
...
```
"""
function add(lhs::Value, rhs::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
...
```
"""
function angle(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function conj(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function cos(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function div(lhs::Value, rhs::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function exp(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function expm1(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function im(complex::Value; imaginary=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function log1p(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function log(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function mul(lhs::Value, rhs::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function neg(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function pow(lhs::Value, rhs::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function re(complex::Value; real=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function rsqrt(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function sign(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function sin(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function sqrt(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function sub(lhs::Value, rhs::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function tan(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function tanh(complex::Value; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[complex, ]
    owned_regions = Region[]
    successors = Block[]
