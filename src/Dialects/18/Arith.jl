...
```
"""
function addi(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, overflowFlags=nothing, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function addui_extended(lhs, rhs; sum::IR.Type, overflow::IR.Type, location=Location())
...
```
"""
function andi(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function bitcast(in; out::IR.Type, location=Location())
    results = IR.Type[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
    attributes = NamedAttribute[]
...
```
"""
function ceildivsi(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function ceildivui(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function cmpf(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, predicate, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function cmpi(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, predicate, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function divf(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function divsi(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function divui(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function extf(in; out::IR.Type, location=Location())
    results = IR.Type[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function extsi(in; out::IR.Type, location=Location())
    results = IR.Type[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function extui(in; out::IR.Type, location=Location())
    results = IR.Type[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
elementwise.
"""
function fptosi(in; out::IR.Type, location=Location())
    results = IR.Type[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
elementwise.
"""
function fptoui(in; out::IR.Type, location=Location())
    results = IR.Type[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function floordivsi(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function index_cast(in; out::IR.Type, location=Location())
    results = IR.Type[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
integer, the value is truncated.
"""
function index_castui(in; out::IR.Type, location=Location())
    results = IR.Type[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function maxnumf(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function maxsi(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function maxui(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function maximumf(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function minnumf(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function minsi(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function minui(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function minimumf(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
math, contraction, rounding mode, and other controls.
"""
function mulf(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function muli(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, overflowFlags=nothing, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function mulsi_extended(lhs, rhs; low=nothing::Union{Nothing, IR.Type}, high=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function mului_extended(lhs, rhs; low=nothing::Union{Nothing, IR.Type}, high=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function negf(operand; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
...
```
"""
function ori(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function remf(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function remsi(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function remui(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
elementwise.
"""
function sitofp(in; out::IR.Type, location=Location())
    results = IR.Type[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function shli(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, overflowFlags=nothing, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function shrsi(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function shrui(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
math, contraction, rounding mode, and other controls.
"""
function subf(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function subi(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, overflowFlags=nothing, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function truncf(in; out::IR.Type, location=Location())
    results = IR.Type[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function trunci(in; out::IR.Type, location=Location())
    results = IR.Type[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
elementwise.
"""
function uitofp(in; out::IR.Type, location=Location())
    results = IR.Type[out, ]
    operands = API.MlirValue[get_value(in), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function xori(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, location=Location())
    results = IR.Type[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
