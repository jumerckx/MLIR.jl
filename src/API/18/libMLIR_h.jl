...
"""
    mlirLLVMDICompositeTypeAttrGet(ctx, tag, name, file, line, scope, baseType, flags, sizeInBits, alignInBits, nElements, elements)

Creates a LLVM DICompositeType attribute.
"""
function mlirLLVMDICompositeTypeAttrGet(ctx, tag, name, file, line, scope, baseType, flags, sizeInBits, alignInBits, nElements, elements)
    @ccall mlir_c.mlirLLVMDICompositeTypeAttrGet(ctx::MlirContext, tag::Cuint, name::MlirAttribute, file::MlirAttribute, line::UInt32, scope::MlirAttribute, baseType::MlirAttribute, flags::Int64, sizeInBits::UInt64, alignInBits::UInt64, nElements::intptr_t, elements::Ptr{MlirAttribute})::MlirAttribute
end

"""
    mlirLLVMDIDerivedTypeAttrGet(ctx, tag, name, baseType, sizeInBits, alignInBits, offsetInBits)

Creates a LLVM DIDerivedType attribute.
"""
function mlirLLVMDIDerivedTypeAttrGet(ctx, tag, name, baseType, sizeInBits, alignInBits, offsetInBits)
    @ccall mlir_c.mlirLLVMDIDerivedTypeAttrGet(ctx::MlirContext, tag::Cuint, name::MlirAttribute, baseType::MlirAttribute, sizeInBits::UInt64, alignInBits::UInt32, offsetInBits::UInt64)::MlirAttribute
end
